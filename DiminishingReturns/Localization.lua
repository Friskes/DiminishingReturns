...
L["Direction"] = true
L["Enable test mode"] = "|cff00FF00Enable test mode|r"
L["Enabled"] = true
...
L["Y offset"] = true
L['Icon border'] = true
L['Choose a border style for the icons.'] = true
L['None'] = true
--------------------------------------------------------------------------------
...
L["Blizzard: arena enemies"] = "Blizzard: arena1-5"
L['Party'] = "Blizzard: party1-4"
L["Bottom"] = "Внизу"
L["Bottom left"] = "Внизу слева"
L["Bottom right"] = "Внизу справа"
L["Center"] = "По центру"
L["Direction"] = "Направление роста иконок"
L["Enabled"] = "Включить"
L["Enable test mode"] = "|cff00FF00Режим настройки|r"
...
L["Frame side"] = "Относительно фрейма"
L["Icon anchor"] = "Крепление к фрейму"
L["Icon size"] = "Размер иконки"
L["Icon spacing"] = "Отступ между иконками"
L["Learn categories to show"] = "АвтоВКЛ Категорий"
L['"Reset" sound'] = "Выберите звук:"
L["When enabled, DiminishingReturns will discover the categories to display when you use spells that triggers them."] = "Аддон автоматически включит категории которые были задействованы в бою."
L["Left"] = "Слева"
L["PvE mode"] = "Режим ПвЕ"
L['Check this box to display diminishing returns on mobs. Please remember that diminishing returns usually do not apply to mobs.'] = "Включить отслеживание DR на NPC (Только: Controlled stuns, Random stuns, Taunts, Cyclone)"
L["Reset duration"] = "Продолжительность DR"
L["Right"] = "Справа"
L["Top"] = "Вверху"
L["Top left"] = "Вверху слева"
L["Top right"] = "Вверху справа"
L["Shown categories"] = "Отслеживать категории:"
L[ [=[This category is triggered by the following effects:
%s]=] ] = [=[В этой категории содержатся следующие заклинания:
%s]=]
L["Check this box to attach diminishing return icons to this/these frame/s."] = "Включить отслеживание DR для данного фрейма."
L['Check this to display bogus icons on every supported frames.'] = "Включите что бы отобразить иконки на всех включенных фреймах для настройки."
L["This is the delay between the end of an effect and the time it can be applied at full length again. This delay is officialy 15 seconds but higher values have been recorded. You can do some tests and adjust this value accordingly. This will not affect running diminishing returns."] = "Это время между окончанием эффекта и временем его повторного применения в полном объеме. Официально эта задержка составляет 15 секунд, но были зарегистрированы более высокие значения. Вы можете провести несколько тестов на вашем сервере и соответствующим образом отрегулировать это значение."
L["Anchor to screen"] = "Крепление к экрану"
L["Check this to anchor the icon bar to the screen instead of the unit frame. This allows you to place it whereever you want."] = "Включите что бы прикрепить иконки к экрану, а не к фрейму."
L["Big timer"] = "Цветной таймер"
L['Play sound at reset'] = "Проиграть звук"
L['Check this to play a sound when the diminishing return of a watched category is reset on any target.'] = "Воспроизвести звук при восстановлении DR."
L['Icon border'] = "Окантовка иконок"
L['Choose a border style for the icons.'] = "Выберите стиль окантовки для иконок."
L['None'] = "Нет"
